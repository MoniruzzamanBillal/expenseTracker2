// xpns Design System — Typography
// Install: npx expo install @expo-google-fonts/inter expo-font
// In root layout: const [loaded] = useFonts({ Inter_400Regular, Inter_500Medium, Inter_600SemiBold });
...
/** Reusable TextStyle presets — spread onto <Text style> */
export const text: Record<string, TextStyle> = {
  balance:  { fontSize: 48, fontFamily: fontFamily.semiBold, letterSpacing: -1,   lineHeight: 52 },
  balanceMd:{ fontSize: 32, fontFamily: fontFamily.semiBold, letterSpacing: -0.5, lineHeight: 36 },
  h1:       { fontSize: 28, fontFamily: fontFamily.semiBold, letterSpacing: -0.4, lineHeight: 34 },
